...
type UnderlayNetworkSpec struct {
	...
	// foo is an example field of UnderlayNetwork. Edit underlaynetwork_types.go to remove/update
	// +optional
...
type UnderlayNetworkStatus struct {
	...
	// conditions represent the current state of the UnderlayNetwork resource.
