...
// +kubebuilder:rbac:groups=controller.cloudovn.io,resources=routetables,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=controller.cloudovn.io,resources=routetables/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=controller.cloudovn.io,resources=routetables/finalizers,verbs=update
